/*Add the functionality of computing the page size and displaying the file contents accordingly (even if the page size changes while more is running)*/
